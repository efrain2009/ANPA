...
/**
 * Clase que verifica que el GPS esté activo, si no lo está, solicita al usuario que lo active.
 * @author eperaza
...
public class Gps implements LocationListener{
	...
	/**
	 * Se verifica que el GPS está activo, sino solicita al usuario que lo active.
	 * @param pActivity
	...
	/**
	 * Toma los datos de la respuesta del activity y comprueba que el GPS esté activo, sino lanza un mensaje
	 * informando que la operación no se puede terminar si no se activa.
	 * @param requestCode
	 * @param resultCode
	 * @param data
	 * @param pActivity
	...
	/**
	 * Retorna la localización actual.
	 * @param plocationManager
	 * @return
	 */
	...
	/**
	 * Verifica que el dispositivo está conectado a internet, sino se abre la configuración
