...
public class LostSearchActivity extends AnpaAppFraqmentActivity {
	...
	private SpinnerAdapter adapter;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			adapter = new SpinnerAdapter(LostSearchActivity.this,
			...
			Button btnSearchLost = (Button)findViewById(R.id.btn_lost_search);
			btnSearchLost.setOnClickListener(onSearch);
		}
		...
		private OnItemSelectedListener onSelectItem = new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                Toast.makeText(LostSearchActivity.this, "Seleccionado: " + selectedItem.getName() + "\n ID: " + selectedItem.getValue(),
		...
		private OnClickListener onSearch = new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(LostSearchActivity.this, LostActivity.class));
			}
		};
}
